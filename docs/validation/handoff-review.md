...
- The proposals in [NEXT.md](../planning/backlog-notes.md) are unchanged and remain unimplemented/unapproved.
...
This note updates the verification status recorded at handoff in [STATE.md](../status.md),
[KNOWN-ISSUES.md](known-issues.md), and [VALIDATION.md](results.md); those historical statements describe v8
