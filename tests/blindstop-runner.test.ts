...
function setup(pace: 'manual' | 'auto' = 'manual') {
  ...
  expect(runner.intent(connections[0]!, { actionId: 'start', command: { type: 'start', gameId: 'blindstop', settings: { rounds: 2, pace, practice: false } } }).accepted).toBe(true);
